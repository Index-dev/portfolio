...
var Base = function Base(_ref) {
  ...
  var onDoubleClickMainContainer = function onDoubleClickMainContainer() {
    if (mainContainerRef.current) {
      window.scrollBy({
        top: mainContainerRef.current.getBoundingClientRect().bottom,
        behavior: 'smooth'
      });
    }
  };
