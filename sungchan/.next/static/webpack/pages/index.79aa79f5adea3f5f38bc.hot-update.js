...
})(["background-color:#fff;width:calc(100vw - (100vw - 100%));height:100vh;position:absolute;top:calc(100vh - 250px);left:calc(100vw - (100vw - 100%) - 450px);transform:rotate(-10deg);z-index:200;transition-duration:5s;transition-timing-function:ease-out;&:hover{top:-100vh;left:-100vw;transform:rotate(60deg);}"]);
_c7 = TestDiv;
