...
})(["background-color:#fff;width:calc(100vw - (100vw - 100%));height:100vh;position:absolute;top:calc(100vh - 250px);left:calc(100vw - (100vw - 100%) - 450px);transform:rotate(-60deg);z-index:200;transition-duration:2s;transition-timing-function:ease-out;&:hover{top:0;left:0;transform:rotate(0deg);}"]);
_c7 = TestDiv;
